            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Data Stok Barang</div>
    ...
    <div class="col-xl-3 col-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total Data Gudang</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $gudang; ?></div>
                    </div>
                    <div class="col-auto">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="table-responsive">
                <table class="table mb-0 table-sm table-striped text-center">
                    ...
                    <tbody>
                        <?php foreach ($transaksi['barang_masuk'] as $bm) : ?>
                            <tr>
                                <td><strong><?= $bm['tanggal_masuk']; ?></strong></td>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="table-responsive">
                <table class="table mb-0 table-sm table-striped text-center">
                    ...
                    <tbody>
                        <?php foreach ($transaksi['barang_keluar'] as $bk): ?>
                            <tr>
                                <td><strong><?= $bk['tanggal_keluar']; ?></strong></td>
