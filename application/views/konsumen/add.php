        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="id_konsumen">ID Konsumen</label>
                    <div class="col-md-9">
                       <div class="input-group">
                        <div class="input-group-prepend">
                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-id-card"></i></span>
                            </div>    
                        <input readonly value="<?= set_value('id_konsumen', $id_konsumen); ?>" name="id_konsumen" id="id_konsumen" type="text" class="form-control" placeholder="ID Barang...">
                    </div>
                        <?= form_error('id_konsumen', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                 <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <input value="<?= set_value('nama_konsumen'); ?>" name="nama_konsumen" id="nama_konsumen" type="text" class="form-control" placeholder="Nama Konsumen...">
                    </div>
                 ...
                 <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <textarea name="alamat_konsumen" id="alamat_konsumen"class="form-control" rows="4" placeholder="Alamat Konsumen..."><?= set_value('alamat_konsumen'); ?></textarea> 
                    </div>
