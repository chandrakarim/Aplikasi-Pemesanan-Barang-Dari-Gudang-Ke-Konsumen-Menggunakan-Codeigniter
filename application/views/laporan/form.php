                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="custom-control custom-radio">
                            <input checked value="barang_masuk" type="radio" id="barang_masuk" name="transaksi" class="custom-control-input">
                       ...
                       <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="konsumen_id" name="konsumen_id">Konsumen</label>
                    <div class="col-md-5">
