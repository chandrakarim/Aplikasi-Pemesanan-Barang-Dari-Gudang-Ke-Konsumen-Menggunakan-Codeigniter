            ...
            <div class="card-body">
               ...
               <div class="row form-group">
                 ...
                 <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input readonly="readonly" value="<?= set_value('jumlah',$barang['stok']); ?>" name="stok" id="stok" type="text" class="form-control" placeholder="stok">
                 ...
                 <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input readonly="readonly" value="<?= set_value('harga',$barang['harga']); ?>" name="harga" id="harga" type="text" class="form-control" placeholder="Harga">
