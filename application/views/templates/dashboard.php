...
<head>
    ...
    <title><?= $title; ?> | Aplikasi Pemesanan Barang</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex text-white align-items-center bg-gradient-success justify-content-center" href="">
                <div class="sidebar-brand-icon">
                    <i class="fas fa-boxes"></i>
                </div>
                <div class="sidebar-brand-text mx-3">Pemesanan Barang</div>
            </a>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
            <a class="nav-link collapsed " href="#" data-toggle="collapse" data-target="#collapseMasterpesan" aria-expanded="true" aria-controls="collapseMasterpesan">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Data Pesan</span>
                </a>
                <div id="collapseMasterpesan" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Master Pesan:</h6>
            ...
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('konsumen'); ?>">
                  <i class="fas fa-user-plus"></i>
                    <span>Data Konsumen</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link pb-0" href="<?= base_url('gudang'); ?>">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-dark bg-gradient-success topbar mb-4 static-top shadow-sm">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-3 d-none d-lg-inline small text-capitalize">
                                    <?= userdata('nama'); ?>
                                </span>
