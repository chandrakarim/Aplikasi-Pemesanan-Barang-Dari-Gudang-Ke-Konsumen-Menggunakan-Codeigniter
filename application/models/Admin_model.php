...
class Admin_model extends CI_Model
{
    ...
    public function getBarangMasuk($limit = null, $id_barang = null, $range = null)
    {
        ...
        $this->db->join('gudang g', 'bm.gudang_id = g.id_gudang');
    ...
    public function getBarangKeluar($limit = null, $id_barang = null, $range = null,$konsumen_id=false)
    {
        $this->db->select('*');
        $this->db->join('user u','bk.user_id = u.id_user');
        $this->db->join('konsumen k','bk.konsumen_id = k.id_konsumen');
